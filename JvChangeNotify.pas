...
type
  ...
  protected
    function GetChangeThreadIsRunning: Boolean;
    procedure Change(Item: TJvChangeItem); virtual;
    procedure Loaded; override;
  public
    property ChangeThreadIsRunning: boolean Read GetChangeThreadIsRunning;
  ...
  published
    ...
    // CPsoft Dummy Property FreeOnTerminate
...
function TJvChangeNotify.GetChangeThreadIsRunning: boolean;
begin
...
begin
  ...
  FreeOnTerminate := False; // CPsoft Force False otherwise GetChangeThreadIsRunning doesn't work
end;
    ...
    begin
      ...
      begin
        try
          ...
          // (rom) Assert removed
          // CPsoft Enable Assert to catch broken directories
          try
            Assert(FindNextChangeNotification(FNotifyArray[I]));
          except
            Terminate;
